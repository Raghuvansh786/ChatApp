...
public class MainActivity extends AppCompatActivity implements ConversionListener {
    ...
    private void init() {
        ...
        binding.conversationsRecylerView.setAdapter(conversationsAdapter);
...
//        Log.d(TAG, "loadUserDetails: Image: " +preferenceManager.getString(Constants.KEY_IMAGE) );
    ...
    private final EventListener<QuerySnapshot> eventListener = ((value, error) ->  {
        ...
        if(value !=null) {
            ...
            binding.conversationsRecylerView.smoothScrollToPosition(0);
            binding.conversationsRecylerView.setVisibility(View.VISIBLE);
